...
var PopularActions = map[string]*ActionMetadata{
	...
	"JamesIves/github-pages-deploy-action@v4": {
		...
		Inputs: ActionMetadataInputs{
			...
			"include-github-folder": {"include-github-folder", false, false, ""},
			"lfs":                   {"lfs", false, false, ""},
	...
	"actions/attest-build-provenance@v4": {
		...
		Outputs: ActionMetadataOutputs{
			...
			"attestation-url":    {"attestation-url"},
			"bundle-path":        {"bundle-path"},
			"storage-record-ids": {"storage-record-ids"},
		},
	},
	...
	"actions/create-github-app-token@v3": {
		...
		Inputs: ActionMetadataInputs{
			...
			"permission-actions":           {"permission-actions", false, false, ""},
			"permission-administration":    {"permission-administration", false, false, ""},
			"permission-artifact-metadata": {"permission-artifact-metadata", false, false, ""},
			"permission-attestations":      {"permission-attestations", false, false, ""},
			"permission-checks":            {"permission-checks", false, false, ""},
			"permission-codespaces":        {"permission-codespaces", false, false, ""},
			"permission-contents":          {"permission-contents", false, false, ""},
			"permission-custom-properties-for-organizations":            {"permission-custom-properties-for-organizations", false, false, ""},
			"permission-dependabot-secrets":                             {"permission-dependabot-secrets", false, false, ""},
			"permission-deployments":                                    {"permission-deployments", false, false, ""},
			"permission-discussions":                                    {"permission-discussions", false, false, ""},
			"permission-email-addresses":                                {"permission-email-addresses", false, false, ""},
			"permission-enterprise-custom-properties-for-organizations": {"permission-enterprise-custom-properties-for-organizations", false, false, ""},
			"permission-environments":                                   {"permission-environments", false, false, ""},
			"permission-followers":                                      {"permission-followers", false, false, ""},
			...
			"permission-issues":                                         {"permission-issues", false, false, ""},
			"permission-members":                                        {"permission-members", false, false, ""},
			"permission-merge-queues":                                   {"permission-merge-queues", false, false, ""},
			"permission-metadata":                                       {"permission-metadata", false, false, ""},
			"permission-organization-administration":                    {"permission-organization-administration", false, false, ""},
			"permission-organization-announcement-banners":              {"permission-organization-announcement-banners", false, false, ""},
			"permission-organization-copilot-seat-management":           {"permission-organization-copilot-seat-management", false, false, ""},
	...
	"actions/setup-dotnet@v4": {
		...
		Inputs: ActionMetadataInputs{
			...
			"config-file":           {"config-file", false, false, ""},
			"dotnet-channel":        {"dotnet-channel", false, false, ""},
	...
	"actions/setup-go@v6": {
		...
		Inputs: ActionMetadataInputs{
			...
			"cache-dependency-path": {"cache-dependency-path", false, false, ""},
			"check-latest":          {"check-latest", false, false, ""},
			"go-download-base-url":  {"go-download-base-url", false, false, ""},
			"go-version":            {"go-version", false, false, ""},
			"go-version-file":       {"go-version-file", false, false, ""},
			"token":                 {"token", false, false, ""},
		},
	...
	"actions/setup-java@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"java-version":                {"java-version", false, false, ""},
			"java-version-file":           {"java-version-file", false, false, ""},
			"jdk-file":                    {"jdk-file", false, false, ""},
			"jdkfile":                     {"jdkFile", false, true, "The `jdkFile` input is deprecated. Use `jdk-file` instead."},
			"job-status":                  {"job-status", false, false, ""},
			"mvn-toolchain-id":            {"mvn-toolchain-id", false, false, ""},
			"mvn-toolchain-vendor":        {"mvn-toolchain-vendor", false, false, ""},
			"overwrite-settings":          {"overwrite-settings", false, false, ""},
			...
			"server-password":             {"server-password", false, false, ""},
			"server-username":             {"server-username", false, false, ""},
			"set-default":                 {"set-default", false, false, ""},
			"settings-path":               {"settings-path", false, false, ""},
			"show-download-progress":      {"show-download-progress", false, false, ""},
			"token":                       {"token", false, false, ""},
			"verify-signature":            {"verify-signature", false, false, ""},
			"verify-signature-public-key": {"verify-signature-public-key", false, false, ""},
		},
		Outputs: ActionMetadataOutputs{
			"cache-hit":         {"cache-hit"},
			"cache-primary-key": {"cache-primary-key"},
	...
	"anthropics/claude-code-action@v1": {
		...
		Inputs: ActionMetadataInputs{
			...
			"anthropic_federation_rule_id":   {"anthropic_federation_rule_id", false, false, ""},
			"anthropic_oidc_audience":        {"anthropic_oidc_audience", false, false, ""},
			"anthropic_organization_id":      {"anthropic_organization_id", false, false, ""},
			"anthropic_service_account_id":   {"anthropic_service_account_id", false, false, ""},
			"anthropic_workspace_id":         {"anthropic_workspace_id", false, false, ""},
	...
	"aws-actions/configure-aws-credentials@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"audience":                      {"audience", false, false, ""},
			"aws-access-key-id":             {"aws-access-key-id", false, false, ""},
			"aws-profile":                   {"aws-profile", false, false, ""},
			"aws-region":                    {"aws-region", true, false, ""},
			"aws-secret-access-key":         {"aws-secret-access-key", false, false, ""},
			"aws-session-token":             {"aws-session-token", false, false, ""},
			"custom-tags":                   {"custom-tags", false, false, ""},
			"disable-retry":                 {"disable-retry", false, false, ""},
			...
			"output-credentials":            {"output-credentials", false, false, ""},
			"output-env-credentials":        {"output-env-credentials", false, false, ""},
			"overwrite-aws-profile":         {"overwrite-aws-profile", false, false, ""},
			"retry-max-attempts":            {"retry-max-attempts", false, false, ""},
			"role-chaining":                 {"role-chaining", false, false, ""},
			"role-duration-seconds":         {"role-duration-seconds", false, false, ""},
			"role-external-id":              {"role-external-id", false, false, ""},
	...
	"game-ci/unity-builder@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"enablegpu":                        {"enableGpu", false, false, ""},
			"gitprivatetoken":                  {"gitPrivateToken", false, false, ""},
			"linux64removeexecutableextension": {"linux64RemoveExecutableExtension", false, false, ""},
			"manualexit":                       {"manualExit", false, false, ""},
			"projectpath":                      {"projectPath", false, false, ""},
			"providerstrategy":                 {"providerStrategy", false, false, ""},
			"runashostuser":                    {"runAsHostUser", false, false, ""},
			...
			"unitylicensingserver":             {"unityLicensingServer", false, false, ""},
			"unityversion":                     {"unityVersion", false, false, ""},
			"usehostnetwork":                   {"useHostNetwork", false, false, ""},
			"version":                          {"version", false, false, ""},
			"versioning":                       {"versioning", false, false, ""},
		},
		Outputs: ActionMetadataOutputs{
	...
	"google-github-actions/run-gemini-cli@v0": {
		...
		Inputs: ActionMetadataInputs{
			...
			"github_issue_number":            {"github_issue_number", false, false, ""},
			"github_pr_number":               {"github_pr_number", false, false, ""},
	...
	"openai/codex-action@v1": {
		...
		Inputs: ActionMetadataInputs{
			"allow-bot-users":        {"allow-bot-users", false, false, ""},
	...
	"subosito/flutter-action@v2": {
		...
		Inputs: ActionMetadataInputs{
			...
			"pub-cache":            {"pub-cache", false, false, ""},
	...
	"wearerequired/lint-action@v3": {
		...
		Inputs: ActionMetadataInputs{
			...
			"autopep8_args":                        {"autopep8_args", false, false, ""},
			"autopep8_auto_fix":                    {"autopep8_auto_fix", false, false, ""},
			"autopep8_command_prefix":              {"autopep8_command_prefix", false, false, ""},
			"autopep8_dir":                         {"autopep8_dir", false, false, ""},
			"autopep8_extensions":                  {"autopep8_extensions", false, false, ""},
			"black":                                {"black", false, false, ""},
			"black_args":                           {"black_args", false, false, ""},
			"black_auto_fix":                       {"black_auto_fix", false, false, ""},
			"black_command_prefix":                 {"black_command_prefix", false, false, ""},
			"black_dir":                            {"black_dir", false, false, ""},
			"black_extensions":                     {"black_extensions", false, false, ""},
			"check_name":                           {"check_name", false, false, ""},
			"clang_format":                         {"clang_format", false, false, ""},
			"clang_format_args":                    {"clang_format_args", false, false, ""},
			"clang_format_auto_fix":                {"clang_format_auto_fix", false, false, ""},
			"clang_format_command_prefix":          {"clang_format_command_prefix", false, false, ""},
			"clang_format_dir":                     {"clang_format_dir", false, false, ""},
			"clang_format_extensions":              {"clang_format_extensions", false, false, ""},
			"clippy":                               {"clippy", false, false, ""},
			"clippy_args":                          {"clippy_args", false, false, ""},
			"clippy_auto_fix":                      {"clippy_auto_fix", false, false, ""},
			"clippy_command_prefix":                {"clippy_command_prefix", false, false, ""},
			"clippy_dir":                           {"clippy_dir", false, false, ""},
			"clippy_extensions":                    {"clippy_extensions", false, false, ""},
			"commit":                               {"commit", false, false, ""},
			"commit_message":                       {"commit_message", false, false, ""},
			"continue_on_error":                    {"continue_on_error", false, false, ""},
			"dotnet_format":                        {"dotnet_format", false, false, ""},
			"dotnet_format_args":                   {"dotnet_format_args", false, false, ""},
			"dotnet_format_auto_fix":               {"dotnet_format_auto_fix", false, false, ""},
			"dotnet_format_command_prefix":         {"dotnet_format_command_prefix", false, false, ""},
			"dotnet_format_dir":                    {"dotnet_format_dir", false, false, ""},
			"dotnet_format_extensions":             {"dotnet_format_extensions", false, false, ""},
			"erblint":                              {"erblint", false, false, ""},
			"erblint_args":                         {"erblint_args", false, false, ""},
			"erblint_auto_fix":                     {"erblint_auto_fix", false, false, ""},
			"erblint_command_prefix":               {"erblint_command_prefix", false, false, ""},
			"erblint_dir":                          {"erblint_dir", false, false, ""},
			"erblint_extensions":                   {"erblint_extensions", false, false, ""},
			"eslint":                               {"eslint", false, false, ""},
			"eslint_args":                          {"eslint_args", false, false, ""},
			"eslint_auto_fix":                      {"eslint_auto_fix", false, false, ""},
			"eslint_command_prefix":                {"eslint_command_prefix", false, false, ""},
			"eslint_dir":                           {"eslint_dir", false, false, ""},
			"eslint_extensions":                    {"eslint_extensions", false, false, ""},
			"flake8":                               {"flake8", false, false, ""},
			"flake8_args":                          {"flake8_args", false, false, ""},
			"flake8_auto_fix":                      {"flake8_auto_fix", false, false, ""},
			"flake8_command_prefix":                {"flake8_command_prefix", false, false, ""},
			"flake8_dir":                           {"flake8_dir", false, false, ""},
			"flake8_extensions":                    {"flake8_extensions", false, false, ""},
			"git_email":                            {"git_email", false, false, ""},
			"git_name":                             {"git_name", false, false, ""},
			"git_no_verify":                        {"git_no_verify", false, false, ""},
			"github_token":                         {"github_token", false, false, ""},
			"gofmt":                                {"gofmt", false, false, ""},
			"gofmt_args":                           {"gofmt_args", false, false, ""},
			"gofmt_auto_fix":                       {"gofmt_auto_fix", false, false, ""},
			"gofmt_command_prefix":                 {"gofmt_command_prefix", false, false, ""},
			"gofmt_dir":                            {"gofmt_dir", false, false, ""},
			"gofmt_extensions":                     {"gofmt_extensions", false, false, ""},
			"golint":                               {"golint", false, false, ""},
			"golint_args":                          {"golint_args", false, false, ""},
			"golint_auto_fix":                      {"golint_auto_fix", false, false, ""},
			"golint_command_prefix":                {"golint_command_prefix", false, false, ""},
			"golint_dir":                           {"golint_dir", false, false, ""},
			"golint_extensions":                    {"golint_extensions", false, false, ""},
			"isort":                                {"isort", false, false, ""},
			"isort_args":                           {"isort_args", false, false, ""},
			"isort_auto_fix":                       {"isort_auto_fix", false, false, ""},
			"isort_command_prefix":                 {"isort_command_prefix", false, false, ""},
			"isort_dir":                            {"isort_dir", false, false, ""},
			"isort_extensions":                     {"isort_extensions", false, false, ""},
			"mypy":                                 {"mypy", false, false, ""},
			"mypy_args":                            {"mypy_args", false, false, ""},
			"mypy_auto_fix":                        {"mypy_auto_fix", false, false, ""},
			"mypy_command_prefix":                  {"mypy_command_prefix", false, false, ""},
			"mypy_dir":                             {"mypy_dir", false, false, ""},
			"mypy_extensions":                      {"mypy_extensions", false, false, ""},
			"neutral_check_on_warning":             {"neutral_check_on_warning", false, false, ""},
			"oitnb":                                {"oitnb", false, false, ""},
			"oitnb_args":                           {"oitnb_args", false, false, ""},
			"oitnb_auto_fix":                       {"oitnb_auto_fix", false, false, ""},
			"oitnb_command_prefix":                 {"oitnb_command_prefix", false, false, ""},
			"oitnb_dir":                            {"oitnb_dir", false, false, ""},
			"oitnb_extensions":                     {"oitnb_extensions", false, false, ""},
			"php_codesniffer":                      {"php_codesniffer", false, false, ""},
			"php_codesniffer_args":                 {"php_codesniffer_args", false, false, ""},
			"php_codesniffer_auto_fix":             {"php_codesniffer_auto_fix", false, false, ""},
			"php_codesniffer_command_prefix":       {"php_codesniffer_command_prefix", false, false, ""},
			"php_codesniffer_dir":                  {"php_codesniffer_dir", false, false, ""},
			"php_codesniffer_extensions":           {"php_codesniffer_extensions", false, false, ""},
			"prettier":                             {"prettier", false, false, ""},
			"prettier_args":                        {"prettier_args", false, false, ""},
			"prettier_auto_fix":                    {"prettier_auto_fix", false, false, ""},
			"prettier_command_prefix":              {"prettier_command_prefix", false, false, ""},
			"prettier_dir":                         {"prettier_dir", false, false, ""},
			"prettier_extensions":                  {"prettier_extensions", false, false, ""},
			"pylint":                               {"pylint", false, false, ""},
			"pylint_args":                          {"pylint_args", false, false, ""},
			"pylint_auto_fix":                      {"pylint_auto_fix", false, false, ""},
			"pylint_command_prefix":                {"pylint_command_prefix", false, false, ""},
			"pylint_dir":                           {"pylint_dir", false, false, ""},
			"pylint_extensions":                    {"pylint_extensions", false, false, ""},
			"rubocop":                              {"rubocop", false, false, ""},
			"rubocop_args":                         {"rubocop_args", false, false, ""},
			"rubocop_auto_fix":                     {"rubocop_auto_fix", false, false, ""},
			"rubocop_command_prefix":               {"rubocop_command_prefix", false, false, ""},
			"rubocop_dir":                          {"rubocop_dir", false, false, ""},
			"rubocop_extensions":                   {"rubocop_extensions", false, false, ""},
			"ruff":                                 {"ruff", false, false, ""},
			"ruff_args":                            {"ruff_args", false, false, ""},
			"ruff_auto_fix":                        {"ruff_auto_fix", false, false, ""},
			"ruff_command_prefix":                  {"ruff_command_prefix", false, false, ""},
			"ruff_dir":                             {"ruff_dir", false, false, ""},
			"ruff_extensions":                      {"ruff_extensions", false, false, ""},
			"rustfmt":                              {"rustfmt", false, false, ""},
			"rustfmt_args":                         {"rustfmt_args", false, false, ""},
			"rustfmt_auto_fix":                     {"rustfmt_auto_fix", false, false, ""},
			"rustfmt_dir":                          {"rustfmt_dir", false, false, ""},
			"rustfmt_extensions":                   {"rustfmt_extensions", false, false, ""},
			"standardrb":                           {"standardrb", false, false, ""},
			"standardrb_args":                      {"standardrb_args", false, false, ""},
			"standardrb_auto_fix":                  {"standardrb_auto_fix", false, false, ""},
			"standardrb_command_prefix":            {"standardrb_command_prefix", false, false, ""},
			"standardrb_dir":                       {"standardrb_dir", false, false, ""},
			"standardrb_extensions":                {"standardrb_extensions", false, false, ""},
			"staticcheck":                          {"staticcheck", false, false, ""},
			"staticcheck_args":                     {"staticcheck_args", false, false, ""},
			"staticcheck_auto_fix":                 {"staticcheck_auto_fix", false, false, ""},
			"staticcheck_command_prefix":           {"staticcheck_command_prefix", false, false, ""},
			"staticcheck_dir":                      {"staticcheck_dir", false, false, ""},
			"staticcheck_extensions":               {"staticcheck_extensions", false, false, ""},
			"stylelint":                            {"stylelint", false, false, ""},
			"stylelint_args":                       {"stylelint_args", false, false, ""},
			"stylelint_auto_fix":                   {"stylelint_auto_fix", false, false, ""},
			"stylelint_command_prefix":             {"stylelint_command_prefix", false, false, ""},
			"stylelint_dir":                        {"stylelint_dir", false, false, ""},
			"stylelint_extensions":                 {"stylelint_extensions", false, false, ""},
			"swift_format_lockwood":                {"swift_format_lockwood", false, false, ""},
			"swift_format_lockwood_args":           {"swift_format_lockwood_args", false, false, ""},
			"swift_format_lockwood_auto_fix":       {"swift_format_lockwood_auto_fix", false, false, ""},
			"swift_format_lockwood_command_prefix": {"swift_format_lockwood_command_prefix", false, false, ""},
			"swift_format_lockwood_dir":            {"swift_format_lockwood_dir", false, false, ""},
			"swift_format_lockwood_extensions":     {"swift_format_lockwood_extensions", false, false, ""},
			"swift_format_official":                {"swift_format_official", false, false, ""},
			"swift_format_official_args":           {"swift_format_official_args", false, false, ""},
			"swift_format_official_auto_fix":       {"swift_format_official_auto_fix", false, false, ""},
			"swift_format_official_command_prefix": {"swift_format_official_command_prefix", false, false, ""},
			"swift_format_official_dir":            {"swift_format_official_dir", false, false, ""},
			"swift_format_official_extensions":     {"swift_format_official_extensions", false, false, ""},
			"swiftformat":                          {"swiftformat", false, false, ""},
			"swiftformat_args":                     {"swiftformat_args", false, false, ""},
			"swiftformat_auto_fix":                 {"swiftformat_auto_fix", false, false, ""},
			"swiftformat_command_prefix":           {"swiftformat_command_prefix", false, false, ""},
			"swiftformat_dir":                      {"swiftformat_dir", false, false, ""},
			"swiftformat_extensions":               {"swiftformat_extensions", false, false, ""},
			"swiftlint":                            {"swiftlint", false, false, ""},
			"swiftlint_args":                       {"swiftlint_args", false, false, ""},
			"swiftlint_auto_fix":                   {"swiftlint_auto_fix", false, false, ""},
			"swiftlint_command_prefix":             {"swiftlint_command_prefix", false, false, ""},
			"swiftlint_dir":                        {"swiftlint_dir", false, false, ""},
			"swiftlint_extensions":                 {"swiftlint_extensions", false, false, ""},
			"tsc":                                  {"tsc", false, false, ""},
			"tsc_args":                             {"tsc_args", false, false, ""},
			"tsc_auto_fix":                         {"tsc_auto_fix", false, false, ""},
			"tsc_command_prefix":                   {"tsc_command_prefix", false, false, ""},
			"tsc_dir":                              {"tsc_dir", false, false, ""},
			"tsc_extensions":                       {"tsc_extensions", false, false, ""},
			"xo":                                   {"xo", false, false, ""},
			"xo_args":                              {"xo_args", false, false, ""},
			"xo_auto_fix":                          {"xo_auto_fix", false, false, ""},
			"xo_command_prefix":                    {"xo_command_prefix", false, false, ""},
			"xo_dir":                               {"xo_dir", false, false, ""},
			"xo_extensions":                        {"xo_extensions", false, false, ""},
		},
	},
}
