...
Documents:
  ...
  - List of checks: https://github.com/astral-sh/actionlint/tree/%s/docs/checks.md
  - Usage:          https://github.com/astral-sh/actionlint/tree/%s/docs/usage.md
  - Configuration:  https://github.com/astral-sh/actionlint/tree/%s/docs/config.md
...
func (cmd *Command) Main(args []string) int {
	...
	flags.StringVar(&opts.Ruff, "ruff", "ruff", "Command name or file path of \"ruff\" external command. If empty, Ruff integration will be disabled")
	flags.StringVar(&opts.Pyflakes, "pyflakes", "", "Command name or file path of the optional \"pyflakes\" external command. If empty, pyflakes integration will be disabled")
