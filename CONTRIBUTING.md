...
[![CI](https://github.com/astral-sh/actionlint/actions/workflows/ci.yml/badge.svg)](https://github.com/astral-sh/actionlint/actions/workflows/ci.yml)
...
Some files are generated by scripts in [`scripts/`](./scripts). Regenerate them locally and submit
the source and generated changes together in a pull request. This fork does not run upstream's
...
Run the generator locally and review changes to the registry and generated metadata together.
...
Review the generated activity types against the Actions trigger documentation before opening a pull request.
...
Submit updates to `availability.go` in a pull request with the relevant documentation reference.
